module.exports = function (grunt) {
            ...
            local: {
                ...
                constants: {
                    ENV: {
                        ...
                        STATEMENT_URL: 'https://statement-dev.lyricfinancial.com'
                    }
                }
            },
            development: {
            ...
            sandbox: {
                ...
                constants: {
                    ENV: {
                        ...
                        STATEMENT_URL: 'https://statement-sandbox.lyricfinancial.com'
                    }
                }
            }
        },
     ...
     */
    grunt.registerTask('default', ['clean', 'ngconstant:sandbox', 'build', 'compile']);

    grunt.registerTask('sandbox', ['clean', 'ngconstant:sandbox', 'build', 'compile']);

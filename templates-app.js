angular.module('templates-app', ['demo/_my_membership.tpl.html', 'demo/_my_membership_edit.tpl.html', 'demo/demo.tpl.html']);

angular.module("demo/_my_membership.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("demo/_my_membership.tpl.html",
    "<h2>My Membership</h2>\n" +
    "<div class=\"your-info\">\n" +
...
angular.module("demo/_my_membership_edit.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("demo/_my_membership_edit.tpl.html",
